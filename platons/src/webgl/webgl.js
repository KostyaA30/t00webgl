...
class _webgl {
    ...
    init(idCanvas) {
        ...
        this.gl.createArrayBuffer = function(floatArray, isStatic) {
        ...
        this.gl.createMeshVAO = function(name, arrayInd, arrayVert, arrayNorm, arrayUV, vertLen) {
        ...
        this.gl.loadTexture = function(name, img, doYFlip, noMips) {
        ...
        this.gl.loadCubeMap = function(name, imgArray) {
        ...
        this.gl.fitScreen = function(wp, hp) {
